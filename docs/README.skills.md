...
| **rust-development**     | Idiomatisk Rust-utvikling med cargo, clippy, error handling, async/tokio, unsafe og prosjektoppsett                                                                                                                                                                                                   | [`.github/skills/rust-development/`](../.github/skills/rust-development/SKILL.md)                                                                                                                                                                                                                                      |
